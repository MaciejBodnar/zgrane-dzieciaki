    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
        <div className="bg-blue-500 text-white px-6 py-8 text-center">
          ...
          <h1 className="text-3xl font-bold">Neuroflow® – Aktywny Trening Słuchowy</h1>
        </div>
        ...
        <div className="p-6">
          <img
            ...
            className="w-full h-[300px] object-cover rounded-lg shadow-md mb-8"
          />
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            na podstawie najnowszych osiągnięć naukowych z tej dziedziny...
          </p>
        </div>
